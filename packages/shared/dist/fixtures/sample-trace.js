...
export const SHADOW_ROUTER_ENTITIES = [
...
export const NOMAD_ENTITY_INDEX = [
    {
        chain: "ethereum",
...
export const KNOWN_ENTITIES = [...ENTITY_INDEX.shadowRouter, ...ENTITY_INDEX.nomadBridge];
...
export const NOMAD_TRACE_TRANSFERS = [
    {
        id: "nomad-0",
        chain: "ethereum",
...
export const SAMPLE_BRIDGE_RESOLUTIONS = [
    {
        bridgeTransferId: "bridge-eth-bsc-1",
...
export const NOMAD_BRIDGE_RESOLUTIONS = [
    {
        bridgeTransferId: "nomad-bridge-hop-1",
        sourceChain: "ethereum",
        destinationChain: "bsc",
...
export const FIXTURE_TRANSFERS = [...SAMPLE_TRANSFERS, ...NOMAD_TRACE_TRANSFERS];
export const FIXTURE_BRIDGE_RESOLUTIONS = [
    ...SAMPLE_BRIDGE_RESOLUTIONS,
    ...NOMAD_BRIDGE_RESOLUTIONS
];
export const DEMO_TRACE_REQUEST = {
    chain: "ethereum",
    seedType: "address",
    seedValue: DEMO_WALLET
};
export const DEMO_TX_TRACE_REQUEST = {
    chain: "ethereum",
    seedType: "tx",
    seedValue: DEMO_TX
};
export const NOMAD_TRACE_REQUEST = {
    chain: "ethereum",
    seedType: "address",
    seedValue: NOMAD_DEMO_WALLET
};
export function entityIndex() {
    return new Map(KNOWN_ENTITIES.map((entity) => [`${entity.chain}:${normalizeAddress(entity.chain, entity.address)}`, entity]));
}
