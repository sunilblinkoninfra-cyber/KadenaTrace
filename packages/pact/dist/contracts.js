...
export const FRAUD_REGISTRY_CONTRACT = readFileSync(new URL("../contracts/fraud-registry.pact", import.meta.url), "utf8");
export const TRACE_REGISTRY_CONTRACT = readFileSync(new URL("../contracts/trace-registry.pact", import.meta.url), "utf8");
